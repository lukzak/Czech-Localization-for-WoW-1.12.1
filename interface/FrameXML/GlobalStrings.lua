...
BATTLEGROUND_DRAG_MOVE = "Hold control and drag to move.";
...
BATTLEGROUND_LEFT_CLICK = "Left-click to open menu.";
BATTLEGROUND_RESET_POSITION = "Hold control and right-click to reset position.";
BID = "Bid";
BIDS = "Bids";
BID_STATUS = "Bid Status";
BILLING_NAG_DIALOG = "Your play time expires in %d %s";
BILLING_NAG_WARNING = "Your play time expires in %d minute";
BILLING_NAG_WARNING_P1 = "Your play time expires in %d minutes";
...
CHAT_BUBBLES_TEXT = "Show Chat Bubbles";
...
DEFAULT_STRENGTH_TOOLTIP = "Increases attack power with melee weapons.";
...
ERR_GUILD_NAME_NAME_CONSECUTIVE_SPACES = "Consecutive spaces are not allowed.  Enter a new name.";
...
GUILD_BANK_AVAILABLE_AMOUNT_COLON = "Available Amount:";
GUILD_BANK_BUY_TAB = "Buy Tab";
GUILD_BANK_DEPOSITED = "deposited";
GUILD_BANK_DESTROYED = "destroyed";
GUILD_BANK_FULL_ACCESS = "Full Access";
GUILD_BANK_LOCKED = "Locked";
GUILD_BANK_LOG = "Log";
GUILD_BANK_LOG_UNLOCK_BANK = "unlocked Guild Bank for";
GUILD_BANK_LOG_UNLOCK_TAB1 = "unlocked a Guild Tab with Guild Money for";
GUILD_BANK_LOG_UNLOCK_TAB2 = "unlocked a Guild Tab with Personal Money for";
GUILD_BANK_MANAGE = "Right-click to manage";
GUILD_BANK_MAXIMUM_STACKS = "Maximum stacks a member can withdraw weekly.";
GUILD_BANK_MINIMUM_RANK = "Minimum Rank to access this tab.";
GUILD_BANK_MONEY_LOG = "Money Log";
GUILD_BANK_NOT_UNLOCKED = "Guild Bank not available. Ask your Guild Master to unlock it.";
GUILD_BANK_NO_LOG = "Nothing here";
GUILD_BANK_NPC_TITLE = "Snatchcents";
GUILD_BANK_POPUP_DEPOSIT = "Amount to deposit:";
GUILD_BANK_POPUP_INVALID_NAME = "Tab name is not valid";
GUILD_BANK_POPUP_UNLOCK = "Unlock Guild Bank for %s gold?";
GUILD_BANK_POPUP_UNLOCK_TAB = "Unlock Tab %s for %s gold?";
GUILD_BANK_POPUP_UNLOCK_TAB_BUTTON1 = "Guild Bank Gold";
GUILD_BANK_POPUP_UNLOCK_TAB_BUTTON2 = "Personal Gold";
GUILD_BANK_POPUP_WITHDRAW = "Amount to withdraw:";
GUILD_BANK_QUANTITY = "in Guild Bank";
GUILD_BANK_RANK_ACCESS_COLON = "Rank Access:";
GUILD_BANK_REMAINING_WITHDRAWALS = "Remaining Weekly Withdrawals";
GUILD_BANK_TAB_SETTINGS = "Tab Settings";
GUILD_BANK_TITLE = "Guild Bank";
GUILD_BANK_WEEKLY_WITHDRAWALS_COLON = "Weekly Withdrawals:";
GUILD_BANK_WITHDRAWAL_UNLIMITED = "Unlimited";
GUILD_BANK_WITHDREW = "withdrew";
...
INSTANCE_COMPLETE_MESSAGE = "The battle has ended. This battleground will close in %s";
...
LFT_CHAT_ERROR_COMBINATION_MSG = "LFT: Invalid party setup. Your group must have 1 tank, 1 healer, and 3 DPS."
LFT_CHAT_ERROR_INTERNAL_MSG = "LFT encountered an unexpected error."
LFT_CHAT_ERROR_LEADER_MSG = "LFT: Only the party leader can perform this action."
LFT_CHAT_ERROR_MISMATCH_MSG = "LFT: Party member levels do not match."
LFT_CHAT_OFFER_DECLINED_TEXT = "You declined the offer and have been taken out of the queue."
LFT_CHAT_QUEUE_JOIN_TEXT = "You are now in the queue."
LFT_CHAT_SELECTED_ROLES_TEXT = " has chosen these roles: "
LFT_DROPDOWN_TYPE_1 = "Recommended Dungeons"
LFT_DROPDOWN_TYPE_2 = "All Dungeons"
LFT_DROPDOWN_LABEL_TEXT = "Type:"
LFT_GENERAL_BROWSE_TAB_TEXT = "Browse"
LFT_GENERAL_LEAVE_QUEUE_TEXT = "Leave Queue"
LFT_GENERAL_LOW_LEVEL_TEXT = "You must reach level 13 to access this feature."
LFT_GENERAL_INSTANCE_TYPE_TEXT = "Type:"
LFT_GENERAL_IN_RAID_TEXT = "Group finder is disabled while you are in a raid."
LFT_GROUP_READY_GROUP_FORMED_TEXT = "A group is set for:"
LFT_GROUP_READY_COMPLETE_TEXT = "Your dungeon group is ready. Good luck!"
LFT_GROUP_READY_CONFIRM_TEXT = "Ready to start!"
LFT_GROUP_READY_STATUS_TEXT = "Ready check in progress"
LFT_GROUP_READY_YOUR_ROLE_TEXT = "Your Chosen Role"
LFT_MAIN_BUTTON_FIND_GROUP_TEXT = "Look for Group"
LFT_MAIN_BUTTON_FIND_MORE_TEXT = "Look for More"
LFT_MINIMAP_TOOLTIP_LINE_1 = "Group Finder"
LFT_MINIMAP_TOOLTIP_LINE_2 = "Left-click to access group finder."
LFT_MINIMAP_TOOLTIP_LINE_3 = "Hold Ctrl and drag to reposition."
LFT_MINIMAP_TOOLTIP_LINE_4 = "Hold Ctrl and right-click to reset position."
LFT_MINIMAP_TOOLTIP_NO_QUEUE = "You are not queued for any group."
LFT_MINIMAP_TOOLTIP_QUEUED = "Currently queued for: "
LFT_ROLE_CHECK_CONFIRM_TEXT = "Accept"
LFT_ROLE_CHECK_DECLINE_TEXT = "Reject"
LFT_ROLE_CHECK_INSTANCES_TEXT = "Current queue: "
LFT_ROLE_CHECK_MULTIPLE_INSTANCES_TEXT = "Queued for |cffffffffseveral dungeons"
LFT_ROLE_CHECK_TITLE_TEXT = "Role Confirmation"
LFT_ROLE_DAMAGE_TOOLTIP = "Shows that you are willing to\ndeal damage to enemies as your role."
LFT_ROLE_HEALER_TOOLTIP = "Shows that you are willing to\nheal and support your allies."
LFT_ROLE_TANK_TOOLTIP = "Shows that you are willing to\nprotect the group by keeping\nenemies focused on you."
...
MINIMAP_BATTLEGROUND_ALTERAC = "Alterac Valley";
MINIMAP_BATTLEGROUND_ALTERAC_TOOLTIP = "Queue for Alterac Valley";
MINIMAP_BATTLEGROUND_ARATHI = "Arathi Basin";
MINIMAP_BATTLEGROUND_ARATHI_TOOLTIP = "Queue for Arathi Basin";
MINIMAP_BATTLEGROUND_WARSONG = "Warsong Gulch";
MINIMAP_BATTLEGROUND_WARSONG_TOOLTIP = "Queue for Warsong Gulch";
...
OPTION_TOOLTIP_SHOW_CASTABLE_BUFFS = "Show only Buffs the player can cast.";
...
OPTION_TOOLTIP_SHOW_DISPELLABLE_DEBUFFS = "Show only Debuffs that the player can dispel.";
...
PLAYER = "Player";
PLAYER_COUNT_ALLIANCE_P1 = "%d Alliance Players";
PLAYER_COUNT_ALLIANCE = "%d Alliance Player";
PLAYER_COUNT_HORDE_P1 = "%d Horde Players";
...
PVP_ENABLED = "PvP";
PVP_MEDAL1 = "Developer";
PVP_MEDAL2 = "Scarab Lord";
PVP_MEDAL3 = "Cartographer";
PVP_MEDAL4 = "Still Alive";
PVP_MEDAL5 = "Seeker of Knowledge";
PVP_MEDAL6 = "Bloodthirsty";
PVP_MEDAL7 = "Stormwielder";
PVP_MEDAL8 = "Sulfuron Champion";
PVP_MEDAL9 = "Immortal";
PVP_MEDAL10 = "Lorekeeper";
PVP_MEDAL11 = "Diplomat";
...
PVP_RANK_CIVILIAN = "Civilian"; -- Non-combatant NPC
PVP_RANK_CIVILIAN_FEMALE = "Civilian"; -- Non-combatant NPC
...
SHOP_ABOUT_TEXT = "Important information about donation rewards:\r\n\r\n• Non-hardcore characters have a 48-hour window to request refunds on donation rewards throught due Snaggle Gratefulgrip.\r\n\r\n• If your Hardcore character dies, your tokens will be automatically refunded. You can use a Hardcore character to preview donation rewards safely.\r\n\r\n• Deleting a non-hardcore character does not refund any tokens spent.\r\n\r\n• Items shown in grey are currently unusable due to missing requirements.\r\n\r\nIf you have any questions or encounter problems, please open a GM ticket or ask in our official Discord."
SHOP_ABOUT_TITLE = "About";
SHOP_BALANCE = "Balance: ";
SHOP_CHAT_COMMAND = "/shop";
SHOP_CONFIRM = "Buy [%s] for %d points?";
SHOP_MSG_CANT_PROCESS = "Unable to complete payment.";
SHOP_MSG_FULL_BAGS = "Inventory full. Cannot obtain item.";
SHOP_MSG_INSUFFICIENT_TOKENS = "Insufficient balance for this item.";
SHOP_MSG_UNKNOWN_ERR = "Unknown error";
SHOP_MSG_UNKNOWN_ITEM = "Item currently unavailable.";
SHOP_THANKS = "Your contribution to RaspyWoW is appreciated!";
SHOP_TITLE = "RaspyWoW Donation Rewards";
SHOP_TOOLTIP1 = "Donation Rewards";
SHOP_TOOLTIP2 = "Left-click to open.";
SHOP_TOOLTIP3 = "Right-click to hide this button.";
SHOP_TOOLTIP4 = "Hold Ctrl and drag to move.";
SHOP_TOOLTIP5 = "Hold Ctrl and right-click to reset position.";
...
SHOW_CASTABLE_BUFFS_TEXT = "Show Castable Buffs";
SHOW_CLOAK = "Show Cloak";
SHOW_COMBAT_TEXT_TEXT = "Enable Floating Combat Text";
SHOW_DAMAGE_TEXT = "Show Target Damage";
...
SHOW_MULTIBAR1_TEXT = "Show Bottom Left ActionBar";
SHOW_MULTIBAR2_TEXT = "Show Bottom Right ActionBar";
SHOW_MULTIBAR3_TEXT = "Show Right ActionBar";
SHOW_MULTIBAR4_TEXT = "Show Right ActionBar 2";
...
SHOW_PARTY_PETS_TEXT = "Show Party Members' Pets";
...
SHOW_TARGET_OF_TARGET_TEXT = "Show Target of Target";
SHOW_TIPOFTHEDAY_TEXT = "Show Loading Screen Tips";
...
SPELL_DETAIL = "Spell Detail Level";
...
TRANSFER_ABORT_ERROR = "Transfer Aborted: Unknown Error"; -- Not supposed to see this one
...
TRANSMOG_ANCHOR_CLOSED = "Anchor window closed. Use /transmog to open it again.";
TRANSMOG_APPEARANCE_COLLECTED = "has been added to your collection.";
TRANSMOG_APPLY_FOR = "Apply for";
TRANSMOG_APPLY_RESET = "Apply Reset";
TRANSMOG_CHANGED_TO = "Transmogrified to:";
TRANSMOG_TRANSMOG_COIN = "Transmog Coin";
TRANSMOG_TRANSMOG_COINS = "Transmog Coin(s)";
TRANSMOG_INSTRUCTIONS = "Ready for a new style?\nPick the item you want to change and update your appearance.";
TRANSMOG_INSUFICCIENT_COINS = "Not enough Transmog Coins";
TRANSMOG_ITEMS = "Items";
TRANSMOG_NEW_OUTFIT = "New Outfit";
TRANSMOG_NO_ITEM = "No item equipped in this slot.";
TRANSMOG_NO_MOGS = "Appearance not unlocked. Equip the item to reveal its look.";
TRANSMOG_OUTFITS = "Outfits";
TRANSMOG_OUTFIT_DELETE = "Delete Outfit?";
TRANSMOG_OUTFIT_NAME = "Enter Outfit Name";
TRANSMOG_OUTFIT_NAME_EMPTY = "Outfit Name not valid.";
TRANSMOG_OUTFIT_NAME_TAKEN = "Outfit Name already exists.";
TRANSMOG_REVERT = "Right-click to revert";
TRANSMOG_SELECT_OUTFIT = "Select Outfit";
TRANSMOG_SETS = "Sets";
TRANSMOG_SET_BONUS = "Note: Set bonus is active even if not displayed.";
...
HF_TITLES_EARNED = "You have unlocked \"%s\" title.";
HF_TITLES_SELECT = "Select a title";
...
UNIT_POPUP_FRAME_LOCK = "Lock Frame";
UNIT_POPUP_FRAME_UNLOCK = "Unlock Frame";
UNIT_POPUP_MOVE = "Unlock Frame";
UNIT_POPUP_MOVE_RESET = "Reset Position";
